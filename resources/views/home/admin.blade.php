<div class="card w-100">
    ...
    <div class="card-body text-center mb-4">
      ...
      <p class="card-text">Selamat datang di Web Applikasi persediaan sederhana kami <span class="text-danger fw-bold">Admin</span> <span class="text-primary fw-bold">{{ session()->get('login')['name'] }}</span>.</p>
